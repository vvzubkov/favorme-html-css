...
$(window).on('load',function(){
    ...
    owl.owlCarousel({
        ...
        navClass:['prev','next'],
        dotClass:'dot',
        navText:['<span class="dib va-m"><i class="fa fa-angle-left"></i></span> <span class="dib w-auto pad0 va-m fz11">Назад</span>',
            '<span class="dib w-auto pad0 va-m fz11">Далее</span> <span class="dib va-m"><i class="fa fa-angle-right"></i></span>'],
        loop:false,
        margin:0,
        nav:true,
        dots:true,
