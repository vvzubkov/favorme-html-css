...
!function (a) {
    ...
    a(b).load(function () {
        ...
        init: function () {
            ...
            var b;
            if (this.b.o.length)for (this.l = [], b = 0; b < k.length; b++)-1 != a.inArray(k[b].iso2, this.b.o) && this.l.push(k[b]); else this.l = k;
            ...
            for (var a = 0; a < this.b.p.length; a++) {
                var b = this.b.p[a], c = this._y(b, !1, !0);
                c && this.n.push(c)
            }
        }, _f: function () {
            ...
            this.h = a("<div>", {"class": "flag"}).appendTo(c), a("<div>", {"class": "arrow"}).appendTo(this.h), this.i = a("<ul>", {"class": "country-list v-hide"}).appendTo(b), this.n.length && (this._g(this.n, "preferred"), a("<li>", {"class": "divider"}).appendTo(this.i)), this._g(this.l, ""), this.j = this.i.outerHeight(), this.i.removeClass("v-hide").addClass("hide"), this.b.r && this.i.outerWidth(this.g.outerWidth()), this.k = this.i.children(".country")
        }, _g: function (a, b) {
            ...
            this.b.a && this.g.on("keypress" + this.ns, function (c) {
                if (c.which >= i.i && !c.metaKey && b.intlTelInputUtils) {
                    c.preventDefault();
                    var d = c.which >= i.g && c.which <= i.h || c.which == i.f, e = a.g[0], f = a.d && e.selectionStart == e.selectionEnd, g = a.g.attr("maxlength"), h = g ? a.g.val().length < g : !0;
                    if (h && (d || f)) {
                ...
                if (c.which == i.d); else if (a.b.a && b.intlTelInputUtils) {
            ...
            var c = this.g.val(), d = null, e = !1, f = this.g[0];
            if (this.d) {
                var g = f.selectionEnd, h = c.length;
            ...
            var b = this._af(a);
            if (b) {
                var c = this.m[this._m(b)], d = !1;
                if (this.o)for (var e = 0; e < c.length; e++)c[e] == this.o.iso2 && (d = !0);
                if (!d || this._w(a, b))for (var f = 0; f < c.length; f++)if (c[f]) {
                    this._z(c[f]);
                    break
                }
            }
            ...
            if (b.intlTelInputUtils && !this.e) {
                var a = this.o.iso2, c = intlTelInputUtils.numberType[this.b.t || "FIXED_LINE"], d = intlTelInputUtils.getExampleNumber(a, this.b.n, c);
            ...
            var d, e = this.g.val();
            if (b = "+" + b, this.b.n && "+" != e.substr(0, 1))d = e; else if (e) {
                var f = this._af(e);
            ...
            var c = a.trim(this.g.val()), d = this.b.n ? this.o.iso2 : "", e = /[a-zA-Z]/.test(c);
